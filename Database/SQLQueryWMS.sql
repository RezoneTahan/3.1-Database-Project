...
update staff_warehouse set staff_warehouse.s_password='adib_45' where staff_warehouse.s_password='adib_44'  

select staff_warehouse.name,staff_warehouse.s_password from staff_warehouse where name= '' and s_password=''

select * from staff_warehouse
...
(
	staff_id int identity(1100,1) primary key,
	name varchar(15) not null,
	staff_address varchar(50) not null,
	phone_no varchar(11) not null,
	email varchar(50) not null,
